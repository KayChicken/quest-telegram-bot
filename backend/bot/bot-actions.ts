...
const stages: Record<string, Stage> = {
  ...
  "stage_16-1": {
    ...
    action: (msg, chatID) => {
      return msg === "МОЛИТВА О СПАСЕНИИ БЛИЖНИХ"
        ? "stage_17-1"
        : "stage_17-2";
    },
  },
  ...
  "stage_35-1": {
    sendText: () =>
      "Отлично!\n\nВы ответили верно и заработали 80 сердечек ❤️\n\nЭто фрагмент фрески протоевангельского (то есть до событий Это фрагмент иконы Богородицы «Гора Нерукосечная» — здесь у Приснодевы облачные одежды, гора и лествица в руках, а вместо звезд приснодевства — красноликие ангелы. Почему все так, рассказываю на курсе «Лествица в небо».",
